...
#define CONFIG_BAIDU_ACCESS_KEY     "tLfDnkpqLoE0dvjlSjOc1B6y"   
#define CONFIG_BAIDU_SECRET_KEY     "jh85lHQQ1kaN5HT9AjI10CnOT48YHkMz"   


#define LCD_HOST  SPI2_HOST
#define USE_BOARD_C3 1
#if USE_BOARD_C3
    ...
    while (1) {
        ...
        if (msg.cmd == PERIPH_BUTTON_PRESSED) {
            ...
            if (original_text == NULL) {
                minimax_content[0]=0; // 清空minimax文本清空
                continue;
            }
...
void app_main(void)
{
    ...
    /******************* 初始化化液晶屏背光 **********************/
    lcd_brightness_init();
    ESP_ERROR_CHECK(ledc_set_duty(LEDC_LOW_SPEED_MODE, LEDC_CHANNEL_0, 8191*(1-0.5)));  // 设置占空�? 0.5表示占空比是50%
